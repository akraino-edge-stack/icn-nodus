...
RUN apt-get update && apt-get upgrade -y && apt-get install -y iproute2 curl software-properties-common setpriv dpkg-dev netcat-openbsd jq wget && rm -rf /var/lib/apt/lists/*
